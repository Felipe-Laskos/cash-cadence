defmodule CashCadenceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CashCadenceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CashCadenceWeb.Gettext, "errors", msg, opts)
    end
  end
