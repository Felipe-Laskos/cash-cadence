defmodule CashCadenceWeb.Router do
  use CashCadenceWeb, :router

  import CashCadenceWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CashCadenceWeb.Layouts, :root}
  ...
  # scope "/api", CashCadenceWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:cash_cadence, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CashCadenceWeb.Telemetry
  ...
  scope "/", CashCadenceWeb do
    ...
    live_session :current_user,
      on_mount: [{CashCadenceWeb.UserAuth, :mount_current_scope}] do
