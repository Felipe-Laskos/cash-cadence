defmodule CashCadenceWeb.UserLive.SettingsTest do
  ...
  describe "Settings page" do
    ...
    test "redirects if user is not logged in", %{conn: conn} do
      ...
      assert %{"error" => "Entre para acessar esta página."} = flash
    end
    ...
    test "redirects if user is not in sudo mode", %{conn: conn} do
      ...
      assert conn.resp_body =~ "Confirme sua identidade para acessar esta página."
    end
  end
  ...
  describe "update email form" do
    ...
    test "updates the user email", %{conn: conn, user: user} do
      ...
      assert result =~ "Enviamos um link de confirmação"
  ...
  describe "confirm email" do
    ...
    test "updates the user email once", %{conn: conn, user: user, token: token, email: email} do
      ...
      assert message == "E-mail alterado."
    ...
    test "redirects if user is not logged in", %{token: token} do
      ...
      assert path == ~p"/users/log-in"
      assert %{"error" => message} = flash
      assert message == "Entre para acessar esta página."
    end
  end
end
