...
config :cash_cadence, CashCadenceWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CashCadenceWeb.ErrorHTML, json: CashCadenceWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: CashCadence.PubSub,
  live_view: [signing_salt: "qU0/By26"]
...
config :cash_cadence, CashCadence.Mailer, adapter: Swoosh.Adapters.Local
